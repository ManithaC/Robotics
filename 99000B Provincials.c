...
#pragma config(Sensor, dgtl2,  back_sonar,     sensorSONAR_cm)
#pragma config(Sensor, dgtl4,  side_sonar,     sensorSONAR_cm)
...
string side, half = "_";
int choice;
string choices[] = {"block","main","exp","off"};
string auton_disp;
int auton = 0;
int claw;
int x_axis, y_axis;
...
int motorpower;
int height;
bool claw_close2, claw_open2 = false;
...
task LCD()
{
	...
	while(true)
	{
		...
		case 4:
			clearLCDLine(0);
			//displayLCDCenteredString(auton_disp);
			waitForPress();
			if(nLCDButtons == 1)
			{
				waitForRelease();
...
//	claw_r = SensorValue[in4] - 80;
//	claw_l = SensorValue[in3] + 0;
//	while(claw_good == false)
//	{
//		motor[Claw1] = (claw - claw_r)*0.2 + /*claw_r_i*0.000*/ - claw_d_r*0.04;
//		motor[Claw2] = (claw - claw_l)*0.2 + /*claw_r_i*0.000*/  - claw_d_l*0.04;
//		if(claw_r - 100 < claw < claw_r + 100 && claw_l - 100 < claw < claw_l + 100)
//		{
//			motor[Claw1] = 0;
//			motor[Claw2] = 0;
//			claw_good = true;
